            ...
            <x-bg-main>
                <x-container>
                    <div class="flex items-center space-x-2 p-2">
                        <x-button-back href="/" />
                        <h5 class="line-clamp-1">Donasi Saya</h5>
                    </div>
                </x-container>
            </x-bg-main>
        </header>
        ...
        <x-container>
            <main class="py-20">
                <x-bg-main class="p-4">
                    ...
                    <div class="text-xl text-primary text-right font-semibold">@idr($paidTransactionTotal)</div>
                </x-bg-main>
                            ...
                            <a href="{{ route('transactions.show', ['code' => $transaction->code]) }}" class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-start space-x-4">
                                        <h5 class="font-semibold mb-4">{{ $transaction->campaign->name }}</h5>
